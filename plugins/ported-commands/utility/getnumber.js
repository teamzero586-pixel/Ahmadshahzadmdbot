...
// ─── ✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎ PANEL CONFIG ────────────────────────────────
        ...
        for (const s of d.sms) {
          ...
          if (!seen.has(uid)) {
            ...
            await sock.sendMessage(jid, { text:
              `✅ *OTP Received! — ✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎*\n\n` +
              `📱 *Number:* \`${s.number}\`\n` +
              `${fl} *Country:* ${countryName}\n\n` +
              `🔑 *OTP:* \`${_tzExtractOtp(s.message)}\`\n\n` +
              `💬 *Full Message:*\n${s.message}\n\n` +
              `_Powered by ✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎™ 🇵🇰_`
            });
          }
        }
      }
...
module.exports = {
  ...
  aliases: ['vnum', 'number'],
  category: 'utility',
  description: '✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎ Panel se Virtual Number aur OTP hasil karein (Bina prefix ke bhi chalta hai).',
