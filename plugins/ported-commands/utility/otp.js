...
// ═══════════════════════════════════════════════════════════
// ✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎ PANEL CONFIG & GLOBAL VARIABLES
// ═══════════════════════════════════════════════════════════
...
module.exports = {
  name: 'otp',
  category: 'utility',
  description: '✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎ Panel se OTP Forwarding aur Traffic check karein.',
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      await extra.react('⚡');
      let vipMenu = `⚡ *✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎ — OTP FORWARDER (PERSONAL)* ⚡\n`;
      vipMenu += `━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n`;
