...
module.exports = {
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || 'A⃟𝐇ΜΔD̰̃~𝐌𝐃-𝐁☯︎𝐓',

    /**
     * @description Owner name
     * @type {string}
     */
    OWNER_NAME: process.env.OWNER_NAME || '✌︎︎𝑨𝑯𝑴𝑨𝑫☠︎︎𝑺𝑯𝑨𝑯𝒁𝑨𝑫✌︎︎',
     ...
     * @type {string}
     */
    CHANNEL_JID: process.env.CHANNEL_JID || '120363407571099651@newsletter',
     ...
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbCx2Sb5q08a3fe3KZ42',
